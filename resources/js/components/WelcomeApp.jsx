            ...
            >
                    ...
                    >
                        ...
                        <div
                            style={{
                                ...
                                height: "300px",
                                borderRadius: "50%",
                                background: "rgba(181,179,178,0.5)",
                                filter: "blur(60px)",
                                pointerEvents: "none",
                            }}
                        />
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    Bergabunglah dengan{" "}
                                    {statsPatients || "50.000+"} pengguna yang
                                    sudah mempercayakan kesehatan mata mereka
                                    kepada MataCeria.
                                </p>
                                ...
                                >
                                    <motion.a
                                        ...
                                        style={{
                                            ...
                                            boxShadow: NM_OUT_MD,
                                            transition:
                                                "all 120ms cubic-bezier(0.25, 0, 0, 1)",
                                        }}
                                    >
                                        <svg
                                            width="18"
                ...
                <footer
                    style={{
                        ...
                        borderTop: "none",
                        boxShadow:
                            "inset 0 2px 6px #b5b3b2, inset 0 -2px 6px #ffffff",
                        padding: "3rem 0",
                    }}
                >
                    <div
