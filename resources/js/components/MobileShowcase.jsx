...
export default function MobileShowcase() {
    ...
    return (
        <section id="app" style={{ padding: '7rem 0', background: '#E7E5E4' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            <motion.a href="#download"
                                ...
                                style={{
                                    ...
                                    boxShadow: NM_OUT_MD, transition: 'all 120ms'
                                }}>
                                ...
                                {[
                                    ...
                                    <motion.a key={item.label} href="#"
                                        ...
                                        style={{
                                            ...
                                            background: '#E7E5E4', color: '#334155', textDecoration: 'none',
